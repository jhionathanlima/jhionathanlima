...
**Scientific Software:**
- **DFT**: [Quantum ESPRESSO / VASP / CP2K / SIESTA]
- **MD**: [LAMMPS / GROMACS]
- **Analysis**: [ASE (Atomic Simulation Environment) / OVITO / VESTA]
- **ML**: [DeepMD-kit / SchNetPack / NequIP]

---

### 📊 GitHub Stats
![Your Stats](https://vercel.app[SeuUsuario]&show_icons=true&theme=tokyonight)

---

### 📫 Connect with me
- **LinkedIn**: [seu-perfil]
- **Lattes (CV)**: [link-do-seu-lattes]
- **ORCID**: [seu-id-orcid]
- **Email**: [seu-email]@fisica.ufpr.br
